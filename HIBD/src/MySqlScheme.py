...
class MySqlScheme:
    ...
    def generatePublicationInfo(self, publisher_id):
        ...
        for i in range(10):
            publicationCollection.append(
                self.Publication_mysql(id=self.id, name=generateRandomString(15), p_type="type",
    ...
    def generate_data(self, start_person_id, other_id):
        ...
        projects = []
        for i in range(5):
            projects.append(self.Scientific_project_mysql(name=generateRandomString(15)))

        job_position = []
        for i in range(5):
            job_position.append(self.Job_mysql(name=generateRandomString(10)))
        ...
        for i in range(100):
            persons.append(
                self.Person_mysql(id=start_person_id, full_name=generateRandomString(8) + " " + generateRandomString(7),
